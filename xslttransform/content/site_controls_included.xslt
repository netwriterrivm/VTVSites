...
<xsl:stylesheet version="1.0" exclude-result-prefixes="asp ucidb" xmlns:ucidb="http://www.piet.nl" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:asp="urn:schemas-microsoft-com:datatypes">
        ...
        <ins>
          <span class="addeditem">
            ...
            <xsl:if test="@layout='Kader 1 Koloms'">
              ...
              <xsl:if test="$childcount>0">
                <div class="nw_kader mod visual nw_information_tekst_container">
                  <xsl:if test="framelabel/@visibilityinframe='hidden' and(framemenu/@layout='visible' or framemenu/@layout='visible_newline' or framemenu/@layout='visible_noline' or framemenu/@layout='visible_newline_noline')">
                    <xsl:attribute name="id">
                      <xsl:apply-templates mode="get_frame_id" select="frameid"></xsl:apply-templates>
                    </xsl:attribute>
  ...
  <xsl:template match="column1" mode="columncont">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="column1_columncont_container_match_media_player" select="self::media_player"></xsl:apply-templates>
      <xsl:apply-templates mode="column1_columncont_container_match_kvz_light_control" select="self::kvz_light_control"></xsl:apply-templates>
    </xsl:for-each>
  </xsl:template>
          ...
          <span class="addeditem">
            <xsl:if test="@level=''">
              <xsl:variable name="header_level">
                <xsl:choose>
                  <xsl:when test="$content_fragment_type='map'">1</xsl:when>
  ...
  <xsl:template match="header" mode="headercont">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="header_headercont_container_match_link_reference" select="self::link_reference"></xsl:apply-templates>
      ...
      <xsl:apply-templates mode="header_headercont_container_match_link_definition" select="self::link_definition"></xsl:apply-templates>
      <xsl:apply-templates mode="header_headercont_container_match_link_object_class" select="self::link_object_class"></xsl:apply-templates>
      <xsl:apply-templates mode="header_headercont_container_match_link_object_document" select="self::link_object_document"></xsl:apply-templates>
      <xsl:apply-templates mode="header_headercont_container_match_link_object_map" select="self::link_object_map"></xsl:apply-templates>
      <xsl:apply-templates mode="header_headercont_container_match_link_object_url" select="self::link_object_url"></xsl:apply-templates>
      <xsl:apply-templates mode="header_headercont_container_match_link_code_file" select="self::link_code_file"></xsl:apply-templates>
      <xsl:apply-templates mode="header_headercont_container_match_link_object_binary_pdf" select="self::link_object_binary_pdf"></xsl:apply-templates>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="reference" mode="referencewriter">
    <xsl:choose>
      <xsl:when test="@IsAdded='True'">
        <ins>
          <span class="addeditem">
            <xsl:variable name="href">#reference_<xsl:value-of select="@reference_id"></xsl:value-of>
            </xsl:variable>
  ...
  <xsl:template match="link_reference" mode="header_headercont_container_match_link_reference">
  ...
  <xsl:template match="definition" mode="definition_writer">
    <xsl:choose>
      <xsl:when test="@IsAdded='True'">
        <ins>
          <span class="addeditem">
            <xsl:variable name="href">#definition_<xsl:value-of select="@definition_id"></xsl:value-of>
            </xsl:variable>
            <xsl:variable name="title">
              <xsl:apply-templates mode="xhtml_title" select="."></xsl:apply-templates>
            </xsl:variable>
  ...
  <xsl:template match="link_definition" mode="header_headercont_container_match_link_definition">
  ...
  <xsl:template match="link_object_class" mode="header_headercont_container_match_link_object_class">
  ...
  <xsl:template match="link_object_document" mode="header_headercont_container_match_link_object_document">
  ...
  <xsl:template match="link_object_map" mode="header_headercont_container_match_link_object_map">
  ...
  <xsl:template match="link_object_url" mode="header_headercont_container_match_link_object_url">
  ...
  <xsl:template match="link_code_file" mode="header_headercont_container_match_link_code_file">
  ...
  <xsl:template match="link_object_binary_pdf" mode="header_headercont_container_match_link_object_binary_pdf">
  ...
  <xsl:template match="caption" mode="captioncont">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="caption_captioncont_container_match_link_code_file" select="self::link_code_file"></xsl:apply-templates>
  ...
  <xsl:template match="link_code_file" mode="caption_captioncont_container_match_link_code_file">
    <xsl:apply-templates mode="para_link_code_file" select="."></xsl:apply-templates>
  </xsl:template>
  ...
  <xsl:template match="subgroup" mode="subgroup_container">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="subgroup_subgroup_container_container_match_dotnetcontrol" select="self::dotnetcontrol"></xsl:apply-templates>
      <xsl:apply-templates mode="subgroup_subgroup_container_container_match_media_player" select="self::media_player"></xsl:apply-templates>
      <xsl:apply-templates mode="box" select="self::box"></xsl:apply-templates>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="dotnetcontrol" mode="subgroup_subgroup_container_container_match_dotnetcontrol">
    <xsl:apply-templates select="." mode="dotnetcontrol_manual"></xsl:apply-templates>
  </xsl:template>
  <xsl:template match="media_player" mode="subgroup_subgroup_container_container_match_media_player">
    <xsl:apply-templates select="." mode="media_player_manual"></xsl:apply-templates>
  </xsl:template>
          ...
          <span class="addeditem">
            <div class="open contrast_lightest">
              <xsl:attribute name="class">
                ...
                <xsl:if test="@foldable='true'"><xsl:text></xsl:text> nw_foldable</xsl:if>
              </xsl:attribute>
              <xsl:choose>
                <xsl:when test="@IsAdded='True'">
                  <ins>
                    <span class="addeditem">
                      <xsl:if test="header/@level=''">
                        <h3>
                          <xsl:attribute name="class"> textHeader2 <xsl:if test="@foldable='true'"> nw_foldable_header</xsl:if>
                          </xsl:attribute>
                      ...
                      <xsl:if test="header/@level='1'">
                        <h2>
                          <xsl:attribute name="class"> textHeader1 <xsl:if test="@foldable='true'"> nw_foldable_header</xsl:if>
                          </xsl:attribute>
                          <xsl:apply-templates mode="headercont" select="header"></xsl:apply-templates>
                        </h2>
                      </xsl:if>
                      <xsl:if test="header/@level='1rs'">
                        <h2>
                          <xsl:attribute name="class"> kb_rsheader <xsl:if test="@foldable='true'"> nw_foldable_header</xsl:if>
                          </xsl:attribute>
                          <xsl:apply-templates mode="headercont" select="header"></xsl:apply-templates>
                        </h2>
                      </xsl:if>
                      ...
                      <xsl:if test="header/@level='3'">
                        <h4>
                          <xsl:attribute name="class"> textHeader3 <xsl:if test="@foldable='true'"> nw_foldable_header</xsl:if>
                          </xsl:attribute>
                          <xsl:apply-templates mode="headercont" select="header"></xsl:apply-templates>
                        </h4>
                      </xsl:if>
    ...
    <xsl:choose>
      <xsl:when test="@IsAdded='True'">
        <ins>
          <span class="addeditem">
            <div>
              <xsl:attribute name="class">mod banner hl_<xsl:value-of select="@color"></xsl:value-of>
              </xsl:attribute>
              <a>
                <xsl:attribute name="href">
                  <xsl:apply-templates select="link_object/*[position()=1]" mode="url"></xsl:apply-templates>
                </xsl:attribute>
  ...
  <xsl:template match="media_player" mode="column1_columncont_container_match_media_player">
    <xsl:apply-templates select="." mode="media_player_manual"></xsl:apply-templates>
  </xsl:template>
  <xsl:template match="kvz_light_control" mode="column1_columncont_container_match_kvz_light_control">
    <xsl:choose>
      <xsl:when test="$releaseoutputmode='2' or $releaseoutputmode='3'">
        <xsl:text disable-output-escaping="yes">&lt;site_controls:WucDisplayToolLight runat="server" id="ctrl_</xsl:text>
        <xsl:value-of select="@XlinkId"></xsl:value-of>
        <xsl:text disable-output-escaping="yes">" ref="</xsl:text>
        <xsl:value-of select="@ref_code"></xsl:value-of>
        <xsl:text disable-output-escaping="yes">" /&gt;</xsl:text>
      </xsl:when>
      <xsl:otherwise>
        <h4>
          <a href="http://www.kostenvanziekten.nl/kvz2005/cijfers/start-tabellen-grafieken-volgens-zorgrekeningen/Default.aspx?ref={@ref_code}">Kosten van Ziekten grafiek of tabel</a>
        </h4>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="column2" mode="columncont">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="banner" select="self::banner"></xsl:apply-templates>
      <xsl:apply-templates mode="box" select="self::box"></xsl:apply-templates>
      <xsl:apply-templates mode="column2_columncont_container_match_media_player" select="self::media_player"></xsl:apply-templates>
      <xsl:apply-templates mode="column2_columncont_container_match_kvz_light_control" select="self::kvz_light_control"></xsl:apply-templates>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="media_player" mode="column2_columncont_container_match_media_player">
    <xsl:apply-templates select="." mode="media_player_manual"></xsl:apply-templates>
  </xsl:template>
  <xsl:template match="kvz_light_control" mode="column2_columncont_container_match_kvz_light_control">
    <xsl:choose>
      <xsl:when test="$releaseoutputmode='2' or $releaseoutputmode='3'">
        <xsl:text disable-output-escaping="yes">&lt;site_controls:WucDisplayToolLight runat="server" id="ctrl_</xsl:text>
        <xsl:value-of select="@XlinkId"></xsl:value-of>
  ...
  <xsl:template match="column3" mode="columncont">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="banner" select="self::banner"></xsl:apply-templates>
      <xsl:apply-templates mode="box" select="self::box"></xsl:apply-templates>
      <xsl:apply-templates mode="column3_columncont_container_match_media_player" select="self::media_player"></xsl:apply-templates>
      <xsl:apply-templates mode="column3_columncont_container_match_kvz_light_control" select="self::kvz_light_control"></xsl:apply-templates>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="media_player" mode="column3_columncont_container_match_media_player">
    <xsl:apply-templates select="." mode="media_player_manual"></xsl:apply-templates>
  </xsl:template>
  <xsl:template match="kvz_light_control" mode="column3_columncont_container_match_kvz_light_control">
    <xsl:choose>
      <xsl:when test="$releaseoutputmode='2' or $releaseoutputmode='3'">
        <xsl:text disable-output-escaping="yes">&lt;site_controls:WucDisplayToolLight runat="server" id="ctrl_</xsl:text>
        <xsl:value-of select="@XlinkId"></xsl:value-of>
  ...
  <xsl:template match="column4" mode="columncont">
    <xsl:for-each select="child::*|text()">
      ...
      <xsl:apply-templates mode="banner" select="self::banner"></xsl:apply-templates>
      <xsl:apply-templates mode="box" select="self::box"></xsl:apply-templates>
      <xsl:apply-templates mode="column4_columncont_container_match_media_player" select="self::media_player"></xsl:apply-templates>
      <xsl:apply-templates mode="column4_columncont_container_match_kvz_light_control" select="self::kvz_light_control"></xsl:apply-templates>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="media_player" mode="column4_columncont_container_match_media_player">
    <xsl:apply-templates select="." mode="media_player_manual"></xsl:apply-templates>
  </xsl:template>
  <xsl:template match="kvz_light_control" mode="column4_columncont_container_match_kvz_light_control">
    <xsl:choose>
      <xsl:when test="$releaseoutputmode='2' or $releaseoutputmode='3'">
        <xsl:text disable-output-escaping="yes">&lt;site_controls:WucDisplayToolLight runat="server" id="ctrl_</xsl:text>
        <xsl:value-of select="@XlinkId"></xsl:value-of>
